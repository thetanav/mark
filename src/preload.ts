...
contextBridge.exposeInMainWorld("electronAPI", {
  vault: {
    ...
    readFile: (filePath: string) =>
      ipcRenderer.invoke("vault:readFile", filePath),
    writeFile: (filePath: string, content: string) =>
      ipcRenderer.invoke("vault:writeFile", filePath, content),
    createFile: (filePath: string) =>
      ipcRenderer.invoke("vault:createFile", filePath),
    ...
    deleteItem: (itemPath: string) =>
      ipcRenderer.invoke("vault:deleteItem", itemPath),
    ...
    commitGit: (message: string) =>
      ipcRenderer.invoke("vault:commitGit", message),
    importMarkdownFile: () => ipcRenderer.invoke("vault:importMarkdownFile"),
  },
  shell: {
    openPathOrUrl: (target: string) =>
      ipcRenderer.invoke("shell:openPathOrUrl", target),
  },
  zoom: {
